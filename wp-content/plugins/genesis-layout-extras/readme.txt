...
For Genesis Framework: Allows modifying of default layouts for homepage, various archives, taxonomies, post types, attachment, search, 404 pages.
...
* Plugin: **bbPress 2.x Forum** (all areas) - plus "Topics" - Integration plugin recommended: [bbPress Genesis Extend](https://wordpress.org/plugins/bbpress-genesis-extend/)
* Plugin: **WooCommerce**: for all taxonomy pages for "Product Categories" and "Product Tags" - Integration plugin recommended: [Genesis Connect for WooCommerce](https://wordpress.org/plugins/genesis-connect-woocommerce/)
* Plugin: **Jigoshop**: for all taxonomy pages for "Product Categories" and "Product Tags" - Integration plugin recommended: [Genesis Connect for Jigoshop](https://www.jigoshop.com/product/genesis-connect-for-jigoshop/)
* Plugin: **Easy Digital Downloads**: Archive Page for Custom Type "Downloads" - plus taxonomies "Download Categories" and "Download Tags" - Integration plugin recommended: [Genesis Connect for Easy Digital Downloads](https://wordpress.org/plugins/genesis-connect-edd/)
...
* French (`fr_FR`) - user-submitted, thanks to [Grégoire Noyelle](https://www.gregoirenoyelle.com/) - 50% complete for v2.0.0 :)
* Italian (`it_IT`) - user-submitted, thanks to Marco Rosselli - currently 36% complete for v2.0.0
...
**UPDATE Will Come!** Yes, an update v2.1.0 is in the works since August 2018 and will release end of August/ beginning of September 2018. So stay tuned. This will mostly be a maintenance release, though. But I am back and you will get further updates. That's what matters, right? ;-)
...
*PLEASE see next FAQ entry:*


= 2018: Still Support for the additional layout options? =
PLEASE NOTE: These 9 additional layouts were added in 2013 under a different situation of the overall market and Genesis. Looking back, it was a mistake to do that, as the whole CSS for Child Themes is just unmanageable! Therefore the support for these layouts cannot and will not be given any longer (as of writing, August 2018)! But rest assured: for backwards compatibility and for the users that somehow used them, I will keep their registering functions and their CSS in the plugin for as long as possible. However, I might be hide the options from the settings page in the future (again this will not affect your usage!). To be clear: I will NOT remove features that were in it for 5 years and of course are used in the wild. I serve my users and the community. But please understand that I cannot longer offer support in any way for THESE ADDITIONAL layout options. You can always register your own options and maintain the CSS for your special use case. No problem at all! :-) --- Thanks for your support!
...
* French (fr_FR): Français - user-submitted by [Grégoire Noyelle](https://www.gregoirenoyelle.com/)
* Italian (it_IT): Italiano - user-submitted by Marco Rosselli
...
UPDATE Will Come! Yes, an update v2.1.0 is in the works and will release end of August/ beginning of September 2018. So stay tuned. This will mostly be a maintenance release, though. But I am back and you will get further updates. That's what matters, right? ;-)
...
== Plugin Links ==
* [Translations (GlotPress)](https://translate.wordpress.org/projects/wp-plugins/genesis-layout-extras)
* [User support forums](https://wordpress.org/support/plugin/genesis-layout-extras)
* [Code snippets archive for customizing, GitHub Gist](https://gist.github.com/deckerweb/6151740)

== Donate ==
Enjoy using *Genesis Layout Extras*? [Please consider making a donation](https://www.paypal.me/deckerweb) to support the project's continued development.
